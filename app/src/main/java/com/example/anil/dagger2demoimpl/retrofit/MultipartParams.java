...
public final class MultipartParams {
    ...
    public static class Builder {
         ...
         * @return the builder
         */
        public Builder addFileWithProgress(final String key, final File mFile, final ProgressRequestBody.UploadCallbacks mCallBack) {
            if (mFile == null) {
                return this;
            }
            map.put(key + "\"; filename=\"" + mFile.getName(), new ProgressRequestBody(mFile, mCallBack));
            return this;
        }
